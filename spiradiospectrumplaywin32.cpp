                     ...
                     int       nCmdShow)
{
	...
	if(nArgs>18)
	{
		global_bands = atoi((LPCSTR)(szArgList[18]));
    ...
    if(nArgs>19)
    {
        global_bgRGBQUAD.rgbRed  = atoi((LPCSTR)(szArgList[19])); //solid background color - red component
    }
    if(nArgs>20)
    {
        global_bgRGBQUAD.rgbGreen  = atoi((LPCSTR)(szArgList[20]));
    }
    if(nArgs>21)
    {
        global_bgRGBQUAD.rgbBlue  = atoi((LPCSTR)(szArgList[21]));
    }
    if(nArgs>22)
    {
        global_c1RGBQUAD.rgbRed  = atoi((LPCSTR)(szArgList[22])); //audio channel1 color - red component
    }
    if(nArgs>23)
    {
        global_c1RGBQUAD.rgbGreen  = atoi((LPCSTR)(szArgList[23]));
    }
    if(nArgs>24)
    {
        global_c1RGBQUAD.rgbBlue  = atoi((LPCSTR)(szArgList[24]));
    }
    if(nArgs>25)
    {
        global_c2RGBQUAD.rgbRed  = atoi((LPCSTR)(szArgList[25])); //audio channel2 color - red component
    }
    if(nArgs>26)
    {
        global_c2RGBQUAD.rgbGreen  = atoi((LPCSTR)(szArgList[26]));
    }
    if(nArgs>27)
    {
        global_c2RGBQUAD.rgbBlue  = atoi((LPCSTR)(szArgList[27]));
    }
